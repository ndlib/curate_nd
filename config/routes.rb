CurateNd::Application.routes.draw do
  ...
  ['etds', 'articles', 'audios', 'datasets', 'senior_theses', 'images', 'patents', 'generic_files', 'finding_aids', 'documents', 'catholic_documents', 'dissertations', 'osf_archives', 'videos'].each do |curation_concern|
  ...
  get 'policies/:policyname', to: 'static_pages#policies'
  get 'tos', to: 'static_pages#tos'
  get 'licenses', to: 'static_pages#licenses'
  get 'subm_agree', to: 'static_pages#subm_agree'
